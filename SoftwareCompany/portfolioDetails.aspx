<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="portfolioDetails.aspx.cs" Inherits="SoftwareCompany.portfolioDetails" %>
...
<head runat="server">
  ...
  <title>Portfolio Details - DOT CONNECT </title>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container">
      <div class="header-container d-flex align-items-center justify-content-between">
        <div class="logo">
          <h1 class="text-light"><a href="index.html"><span>DOT CONNECT</span></a></h1>
        ...
        <nav id="navbar" class="navbar">
          <ul>
            ...
            <li><a class="nav-link scrollto " href="default.aspx">Portfolio</a></li>
